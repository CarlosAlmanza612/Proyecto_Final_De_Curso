 ...
 * @author Usuario
 */
public class ProductoPanel extends Fondo {
    ...
    public ProductoPanel(JFrame jframe) {
        initComponents();
...
//        cargarTabla();
    ...
    private void initComponents() {
        ...
        add(btnResetear, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 300, 80, -1));
