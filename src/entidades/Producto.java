...
public class Producto  implements java.io.Serializable {
    ...
    public Producto(int codigo, Marca marca, Talla talla, String nombre, Double costoDeCompra, Double peso, Double costoDelPeso, Double costoTotal, Double precioDeVenta, Double tipoDeCambio, Boolean disponible, Set ventas) {
       this.codigo = codigo;
       this.marca = marca;
       this.talla = talla;
       this.nombre = nombre;
